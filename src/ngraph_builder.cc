...
static tf::Status TranslateSparseSoftmaxCrossEntropyWithLogitsOp(
  ...
  auto ng_temp = make_shared<ng::op::Multiply>(
      ng_onehot_labels_float, make_shared<ng::op::Log>(ng_features_softmax));
  auto ng_loss =
      make_shared<ng::op::Negative>(make_shared<ng::op::Sum>(ng_temp, ng_axes));
